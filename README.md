...
![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/1.png)

#2.2 Task 2: Understanding MD5’s Property

To test this create a file *hi.txt* and run md5collgen ```-p hi.txt -o hi1 hi2```

![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/2.png)

Verify that the MD5 hashes are the same using md5sum hi1 hi2.

![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/3.png)
...
![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/4.png)
...
![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/5.png)
...
![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/6.png)
A part of agen
![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/7.png)
A portion of bgen
...
![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/8.png)
...
![alt text](https://github.com/sohaib296/MD5-Collision-Attack-Lab/blob/main/9.png)
